...
DOCUMENTATION = r"""
---
module: datadog_log_archive
short_description: Manage Datadog log archives
description:
    - Manage Datadog log archives.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.datadog.datadog_log_archive:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("archive_id",))],
    )
