...
"""Ansible module: datadog_downtime."""
...
short_description: Manage Datadog scheduled downtimes
description:
    - Manage Datadog scheduled downtimes in Datadog.
...
options:
    ...
    downtime_id:
        ...
        type: str
    name:
        description: Display name of the downtime.
        type: str
"""

EXAMPLES = r"""
- name: Create a downtime
  stevefulme1.datadog.datadog_downtime:
    name: my-downtime
    state: present
