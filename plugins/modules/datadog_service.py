...
short_description: Manage Datadog APM services
description:
    - Manage Datadog APM services.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.datadog.datadog_service:
...
def main():
    ...
    if state == "present":
        if resource_id:
            result = client.update("service", resource_id, module.params)
        else:
