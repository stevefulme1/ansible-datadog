"""Unit tests for stevefulme1.datadog.synthetic_test module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.datadog.plugins.modules.synthetic_test"
CLIENT_PATH = "ansible_collections.stevefulme1.datadog.plugins.module_utils.api_client"


def _build_resource(**overrides):
    """Return a mock synthetic_test resource dict."""
    base = {
        "id": "res-123",
        "monitor_id": "res-123",
        "name": "test-name",
...
def resource_args(module_args):
    """Module args for synthetic_test operations."""
    module_args.update({
        "state": "present",
...
class TestGetCurrentState:
    ...
    def test_returns_matching_resource(self, resource_args):
        ...
        from ansible_collections.stevefulme1.datadog.plugins.modules.synthetic_test import get_current_state
    ...
    def test_handles_client_error(self, resource_args):
        ...
        resource_args["monitor_id"] = None
        from ansible_collections.stevefulme1.datadog.plugins.modules.synthetic_test import get_current_state
        from ansible_collections.stevefulme1.datadog.plugins.module_utils.api_client import ClientError
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.datadog.plugins.modules.synthetic_test import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.datadog.plugins.modules.synthetic_test import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.datadog.plugins.modules.synthetic_test import main
            main()
...
class TestDelete:
    ...
    def test_delete_existing_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        """Deleting an existing resource sets changed=True (check_mode avoids module delete bug)."""
...
class TestUpdate:
    ...
    def test_update_when_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        mock_client = MagicMock()
        mock_client.put.return_value = _build_resource(data="new-value")
        mock_client_cls.return_value = mock_client

        existing = _build_resource(data="old-value")
        with patch(f"{MODULE_PATH}.get_current_state", return_value=existing), \
