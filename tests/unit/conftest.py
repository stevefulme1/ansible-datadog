"""Shared fixtures for stevefulme1.datadog unit tests."""
...
# ansible_collections.stevefulme1.datadog resolves to the repo root.
...
_ns_path = os.path.join(_fake_root, 'ansible_collections', 'stevefulme1', 'datadog')
