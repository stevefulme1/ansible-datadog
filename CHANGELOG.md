...
### Added
- Idempotency: get-before-write with state comparison in 25 modules
...
### Added
- Initial release with monitor, dashboard, SLO, synthetic, and downtime modules
- EDA webhook and events source plugins
- Unit tests and CI pipeline
